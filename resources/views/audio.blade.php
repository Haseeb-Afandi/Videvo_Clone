...
@include('header_alt')
    ...
    <div class="px-12">
        <img src="{{ url('/') }}/images/music.jpg" class="absolute left-0 top-0 h-full w-full object-cover opacity-50">
