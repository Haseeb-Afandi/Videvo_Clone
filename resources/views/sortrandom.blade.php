<!DOCTYPE html>
<!-- saved from url=(0054){{ url('/')}}/royalty-free-music/sort/random/ -->
...
<meta property="og:url" content="{{ url('/')}}/royalty-free-music/sort/random/">
...
<link rel="alternate" hreflang="x-default" href="{{ url('/')}}/royalty-free-music/sort/random/">
<link rel="alternate" hreflang="en" href="{{ url('/')}}/royalty-free-music/sort/random/">
<link rel="alternate" hreflang="es" href="{{ url('/')}}/es/musica-libre-de-derechos/sort/random/">
<link rel="alternate" hreflang="de" href="{{ url('/')}}/de/lizenzfreie-musik/sort/random/">

<link rel="next" href="{{ url('/')}}/royalty-free-music/sort/random/?page=2">
...
<link rel="canonical" href="{{ url('/')}}/royalty-free-music/sort/random/">
...
@include('header_alt2')
    ...
    <main class="flex-1">
        ...
        <div class="container mx-auto px-32">
            <div class="mx-auto flex w-1/2 flex-col items-center justify-center">
                <h4 class="mb-6 mt-4 text-xl text-gray-900">
                    <strong>Ooops!</strong>
                    Moved permanently                </h4>
                <div class="mb-6 flex w-full rounded border border-gray-200">
                    <form x-data="initFormSearch()" id="search" action="{{ url('/')}}/search/" class="bg-white h-14 relative flex flex-1 rounded max-w-full">
    ...
    function redirectIstock(url, currentTimestamp) {
        ...
        try {
            ...
            window.dataLayer.push({
                ...
                eventLabel: 'url: ' + "{{ url('/')}}/royalty-free-music/sort/random/"
            });
        ...
        return true;
                ...
                <div class="flex items-center justify-center gap-2">
                    <a href="{{ url('/')}}/stock-video-footage" class="rounded bg-yellow-600 py-1.5 px-4 font-bold text-white hover:bg-yellow-700">
                        Browse videos                    </a>
                    <a href="{{ url('/')}}/" class="rounded bg-blue-400 py-1.5 px-4 font-bold text-white hover:bg-blue-500">
...
<script async="" src="{{ url('/')}}/assets/api_client.js" gapi_processed="true"></script>
    ...
    <link rel="modulepreload" href="{{ url('/')}}/assets/defer-images.b34739b9.js"><script type="module" src="{{ url('/')}}/assets/defer-images.b34739b9.js"></script>    <div wire:id="3wc2hV5uRCwexvZu2H4C">
    </div>

  

<!-- Livewire Component wire-end:3wc2hV5uRCwexvZu2H4C -->    <!-- Hotjar Tracking Code for www.videvo.net. This helps with analytics -->
    <script>
