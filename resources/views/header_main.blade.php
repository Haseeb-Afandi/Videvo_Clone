...
<head>
    ...
    <link href="{{ url('/') }}/css/home_anime.css" rel="stylesheet">
...
<body>
        ...
        <div
            ...
            <div class="flex flex-1 items-center gap-3 sm:gap-4 lg:gap-8 max-lg:!gap-y-0">
                <a href="#" class="flex flex-1 items-center lg:flex-none order-0 sm:min-w-[90px]">
                    <img src="{{ url('/') }}/images/logo-placeholder.png" width="200px" height="50px">
                </a>
                <div class="sengoku flex flex-1 items-center gap-3 sm:gap-4 lg:gap-8 max-lg:!gap-y-0">
                        ...
                        <div class="relative">
                            <nav class="flex-row istock-six:flex">
                                <span class="nav-flex group relative">
                                    <a href="{{ url('/') }}/stock-video-footage"
                    ...
                    <div class="flex items-center gap-2 order-2">
                        <a href="{{ url('/') }}/uploadVid" class="inline-block rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]">
                            UpLoad Video
</a>
                        <script>
    ...
    <div class="relative flex w-full items-center justify-center bg-black pt-14 lg:pt-16 h-[50vh]">
        ...
        <video autoplay="" loop="" class="video-home absolute inset-0 h-full w-full object-cover opacity-50" muted="">
                <source src="{{ url('/') }}/videos/11.mp4" type="video/mp4">
            </video>
        <div class="jidai">
